...
// hills animation 
scene1.to("#h1-1", { y: 3 * speed1, x: 1 * speed1, scale: 0.9, ease: "power1.in" }, 0)
scene1.to("#h1-2", { y: 2.6 * speed1, x: -0.6 * speed1, ease: "power1.in" }, 0)
scene1.to("#h1-3", { y: 1.7 * speed1, x: 1.2 * speed1 }, 0.03)
scene1.to("#h1-4", { y: 3 * speed1, x: 1 * speed1 }, 0.03)
scene1.to("#h1-5", { y: 2 * speed1, x: 1 * speed1 }, 0.03)
scene1.to("#h1-6", { y: 2.3 * speed1, x: -2.5 * speed1 }, 0)
scene1.to("#h1-7", { y: 5 * speed1, x: 1.6 * speed1 }, 0)
scene1.to("#h1-8", { y: 3.5 * speed1, x: 0.2 * speed1 }, 0)
scene1.to("#h1-9", { y: 3.5 * speed1, x: -0.2 * speed1 }, 0)

//animate text
scene1.to("#info", { y: 8 * speed1 }, 0)
